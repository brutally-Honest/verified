          ...
          {latestMember && (
            <div className="flex text-black rounded bg-gradient-to-l from-indigo-200 via-neutral-300 to-stone-300 p-1 shadow">
              <div className="flex flex-col border-r">
                <div className="p-2 text-base ">Name</div>
                {role === "admin" && (
                  <div className="p-2 text-base ">Group</div>
                )}
                <div className="p-2 text-base ">Status</div>
              </div>
              <div className="flex flex-col uppercase  font-semibold text-base">
                ...
                <div className={`p-2 px-1 text-center ${latestMember.status==='pending'?"text-red-500":"text-green-500"}`}>
                  {latestMember.status}
                </div>
              </div>
            </div>
